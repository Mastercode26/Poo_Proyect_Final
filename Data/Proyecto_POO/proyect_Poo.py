...
class Participantes:
    ...
    db_name = r'Proyect_Poo/Participantes.db'
    actualiza = None
    def __init__(self, master=None):
        ...
        self.win.configure(background="pale green", height="480", relief="flat", width="1024")
        self.win.geometry("1024x480")
        #self.path = r'icono.ico'
        ...
        #Botón Grabar
        s.layout("Grabar.TButton", [("Button.padding", {"children": [("Button.label", {"sticky": "nswe"})]})])

        s.configure ("Grabar.TButton", padding=7, background="forest green")
        s.map("Grabar.TButton", background =[("active","lime green")])

        self.btnGrabar = ttk.Button(self.win, style="Grabar.TButton")
        ...
        #Botón Editar
        s.layout("Editar.TButton", [("Button.padding", {"children": [("Button.label", {"sticky": "nswe"})]})])

        s.configure ("Editar.TButton", padding=7, background="forest green")
        s.map("Editar.TButton", background =[("active","lime green")])

        self.btnEditar = ttk.Button(self.win,style="Editar.TButton")        
        ...
        #Botón Eliminar
        s.layout("Eliminar.TButton", [("Button.padding", {"children": [("Button.label", {"sticky": "nswe"})]})])

        s.configure ("Eliminar.TButton", padding=7, background="forest green")
        s.map("Eliminar.TButton", background =[("active","lime green")])

        self.btnEliminar = ttk.Button(self.win,style="Eliminar.TButton")
        ...
        #Botón Cancelar
        s.layout("Cancelar.TButton", [("Button.padding", {"children": [("Button.label", {"sticky": "nswe"})]})])

        s.configure ("Cancelar.TButton", padding=7, background="forest green")
        s.map("Cancelar.TButton", background =[("active","lime green")])

        self.btnCancelar = ttk.Button(self.win, style="Cancelar.TButton")
       ...
       #Encabezados de las columnas de la pantalla
        ...
        self.scrollbar=ttk.Scrollbar(self.lblfrm_Datos, orient='vertical', command=self.treeDatos.yview)
